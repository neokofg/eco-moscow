                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                    ...
                                    <ul id="tocify-subheader-endpoints" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-newses">
                                <a href="#endpoints-GETapi-v1-newses">GET api/v1/newses</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-newses--id-">
                                <a href="#endpoints-GETapi-v1-newses--id-">GET api/v1/newses/{id}</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-v1-videos">GET api/v1/videos</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-videos--id-">
                                <a href="#endpoints-GETapi-v1-videos--id-">GET api/v1/videos/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-videos">
                                <a href="#endpoints-POSTapi-v1-videos">POST api/v1/videos</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-notes">
                                <a href="#endpoints-GETapi-v1-notes">GET api/v1/notes</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-notes--id-">
                                <a href="#endpoints-GETapi-v1-notes--id-">GET api/v1/notes/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-notes">
                                <a href="#endpoints-POSTapi-v1-notes">POST api/v1/notes</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-GETapi-v1-newses">GET api/v1/newses</h2>
...
<span id="example-requests-GETapi-v1-newses">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/newses" \
...
<span id="example-responses-GETapi-v1-newses">
            <blockquote>
...
<span id="execution-results-GETapi-v1-newses" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-newses"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-newses"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-newses" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-newses">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-newses" data-method="GET"
      data-path="api/v1/newses"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-newses', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-newses"
                    onclick="tryItOut('GETapi-v1-newses');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-newses"
                    onclick="cancelTryOut('GETapi-v1-newses');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-newses"
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-newses"
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-newses"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>Must not be greater than 255 characters. Example: <code>c</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-newses--id-">GET api/v1/newses/{id}</h2>
...
<span id="example-requests-GETapi-v1-newses--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-v1-newses--id-">
            <blockquote>
...
<span id="execution-results-GETapi-v1-newses--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-newses--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-newses--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-newses--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-newses--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-newses--id-" data-method="GET"
      data-path="api/v1/newses/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-newses--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-newses--id-"
                    onclick="tryItOut('GETapi-v1-newses--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-newses--id-"
                    onclick="cancelTryOut('GETapi-v1-newses--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-newses--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/newses/{id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-newses--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-newses--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
    ...
    <br>
                    ...
                    <h2 id="endpoints-GETapi-v1-videos--id-">GET api/v1/videos/{id}</h2>
...
<p>The ID of the video. Example: <code>earum</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-videos">POST api/v1/videos</h2>
...
<span id="example-requests-POSTapi-v1-videos">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-videos">
</span>
<span id="execution-results-POSTapi-v1-videos" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-videos"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-videos"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-videos" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-videos">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-videos" data-method="POST"
      data-path="api/v1/videos"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-videos', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-videos"
                    onclick="tryItOut('POSTapi-v1-videos');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-videos"
                    onclick="cancelTryOut('POSTapi-v1-videos');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-videos"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-videos"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-videos"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
    ...
    <br>
                    ...
                    <h2 id="endpoints-GETapi-v1-notes--id-">GET api/v1/notes/{id}</h2>
...
<p>The ID of the note. Example: <code>omnis</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-notes">POST api/v1/notes</h2>
