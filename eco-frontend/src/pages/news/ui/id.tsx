    ...
    <div className="container py-12">
      <div className="bg-background-primary flex flex-col gap-6 gap p-6 rounded-3xl">
        ...
        <div className="flex flex-row gap-6">
          <div className="px-3 py-1 bg-background-tertiary rounded-full">{cat}</div>
        ...
        <div className="flex flex-row gap-8 w-full">
            ...
            <Image width={712} height={516} alt=";" className="bg-background-tertiary rounded-3xl" src={cover} />
        </div>
      </div>
