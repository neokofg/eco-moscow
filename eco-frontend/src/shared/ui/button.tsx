...
const buttonVariants = cva(
  "flex gap-[10px] font-semibold text-base justify-center w-full",
  {
    variants: {
      variant: {
        default:
          "label-base bg-content-green text-content-inverse-primary disabled:bg-zinc-200 disabled:text-zinc-400",
