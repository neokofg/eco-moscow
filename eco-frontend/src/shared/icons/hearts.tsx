...
export const HeartsIcon: FC<IconType> = (props) => {
  ...
  return (
    ...
    >
      ...
      <path
        fill="#A1A1AA"
        d="M8.106 18.247C5.298 16.083 2 13.542 2 9.137 2 4.274 7.5.825 12 5.501 16.5.825 22 4.274 22 9.137c0 .834-.118 1.6-.329 2.31a4.203 4.203 0 00-2.619-.947c-.89-.005-1.758.274-2.553.81-1.39-.933-2.956-1.058-4.33-.395-1.635.79-2.669 2.556-2.669 4.484 0 2.306 1.149 3.923 2.341 5.095-.947-.076-1.896-.808-2.88-1.583-.276-.219-.563-.44-.855-.664z"
      ></path>
    </svg>
  );
};
