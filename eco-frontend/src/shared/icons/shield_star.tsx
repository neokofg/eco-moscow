...
export const ShieldStarIcon: FC<IconType> = (props) => {
  const { colors } = useTheme();
  const { width = 24, height = 24, color = colors.contentTertiary } = props;
  return (
    <svg
